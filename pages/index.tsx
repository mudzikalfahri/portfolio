  ...
  return (
    <Layout>
      <div className="flex justify-between place-items-center">
        <div className="mr-12">
          <div className="w-32 h-32 bg-gradient-to-r from-pink-200 to-purple-400 rounded-full"></div>
        </div>
        <div className="">
          <h3 className="text-3xl pb-2 border-b border-gray-300 w-max font-bold mb-3 flex items-center">
      ...
      <div className="my-10 flex place-items-center hover:shadow-lg duration-200 text-indigo-400 justify-center w-1/2 mx-auto px-5 py-5 bg-white border border-gray-200 rounded-xl">
        <a
